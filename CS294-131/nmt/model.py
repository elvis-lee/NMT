...
from .cells import GRUCellWithBahdanauAttention, GRUCellWithLuongAttention

utils.check_tensorflow_version()

__all__ = ["BaseModel", "Model", "AttentionalModel"]
...
def _single_attentional_cell(unit_type, 
                             num_units,
                             memory,
                             forget_bias, 
                             dropout, 
    ...
    single_cell = unit_type(num_units, memory)
...
def _create_rnn_cell(unit_type, 
                     num_units, 
                     num_layers, 
                     num_residual_layers,
                     memory,
    ...
    single_cell_fn = _single_attentional_cell
    ...
    for i in range(num_layers):
        ...
        single_cell = single_cell_fn(
            ...
            device_str=model_helper.get_device_str(i + base_gpu, num_gpus),
...
class AttentionalModel(Model):
    ...
    def _build_decoder_cell(self, 
        ...
        cell = _create_rnn_cell(
            unit_type=hparams.attention_cell_class,
            num_units=hparams.num_units,
            num_layers=self.num_decoder_layers,
            num_residual_layers=self.num_decoder_residual_layers,
            memory=memory,
